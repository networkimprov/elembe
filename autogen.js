...
layout: [ { class:'inviteEdit', style:'top:40px; left:40px;', pid:'#autogen.00011' } ]
},

{type:'page', oid:'#autogen.00020',
data:{ name:'Services', added:kToday },
layout: [ { class:'serviceEdit', style:'top:40px; left:40px;', pid:'#autogen.00013' } ]
}
...
<p>suae currently has three part editors, for text, images, and attachments.</p>\
